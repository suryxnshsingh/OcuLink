    ...
    return (
        <div className='flex h-screen w-full flex-col items-center justify-center bg-green-50 gap-3 bg-grid-black/[0.2] p-4'>
            ...
            <div className={`relative ${isMobile ? 'w-[95%] h-[70vh]' : 'w-3/4 min-lg:w-2/3'}`}>
                <VideoPreview className={`w-full ${isMobile ? 'h-full' : 'h-[500px]'} rounded-none border-black text-center border-double border-8`} />
                ...
                {showFilters && (
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center z-20 backdrop-blur-sm">
                        <div className="relative bg-white/95 w-fit p-4 rounded-lg border-2 border-black shadow-[5px_5px_0px_rgba(0,0,0,1)] overflow-y-auto">
                            <Button 
                                onClick={toggleFilters}
                            ...
                            <h3 className="text-lg font-bold mb-4 text-center">Media Filters & Effects <br/> (Under Development)</h3>
                            <MediaFilters />
                        </div>
                    </div>
                )}
