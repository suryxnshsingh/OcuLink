...
A clean and elegant NeoBrutalistic UI. Neubrutalism in web design is a trend characterized by minimalist aesthetics, stark typography, and a raw, unpolished appearance.
...
```bash
git clone [https://github.com/adrianhajdin/zoom-clone.git](https://github.com/suryxnshsingh/OcuLink.git)
cd oculink
```
